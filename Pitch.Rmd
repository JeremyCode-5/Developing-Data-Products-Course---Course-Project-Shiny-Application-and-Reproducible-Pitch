...
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**](https://ymerejdaalap.shinyapps.io/CourseProjectShinyApp/)
...
Both files can be found here: [GitHub repo](https://github.com/JeremyCode-5/Developing-Data-Products-Course---Course-Project-Shiny-Application-and-Reproducible-Pitch)
